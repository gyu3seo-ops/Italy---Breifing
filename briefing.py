    ...
    for attempt in range(retries):
        try:
            ...
            resp = client.messages.create(
                ...
                max_tokens=2000,
                system=f"You are a news curator for {date_iso}. CRITICAL DATE RULE: ONLY include articles published on {date_iso}. Verify each article publication date before including it. Articles from any other date must be excluded. Return ONLY a raw JSON array. No markdown, no explanation, no cite tags, no code blocks.",
